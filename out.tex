...
\begin{frame}
    ...
    \begin{figure}[htbp!]
        ...
        \end{minipage}
    \end{figure}
    \footnotetext{Feng, B., B. Dixon, E. Sunny, A. Cuadra, J. Jacobson, N. R. Brown, J. Powers, A. Worrall, S. Passerini, and R. Gregg. “Standardized Verification of Fuel Cycle Modeling.” Annals of Nuclear Energy 94 (August 2016): 300–312. https://doi.org/10.1016/j.anucene.2016.03.002.}
\end{frame}
...
\newcommand{\topic}{Inventory of discharged UNF in mandatory cooling storage}%
\newcommand{\filename}{fuel_discharge}
\begin{frame}
    \frametitle{Results - \topic}
    \begin{figure}[htbp!]
        \begin{minipage}[b]{.45\linewidth}
            \begin{center}
                \includegraphics[width=\textwidth]{./images/literature/\filename.png}
            \end{center}
            \caption{\topic from paper. \footnotemark}
        \end{minipage}
        \hspace{.5cm}
        \begin{minipage}[b]{.45\linewidth}
            \centering
                \includegraphics[width=\linewidth]{./images/results/\filename.png}
            \caption{\topic from \Cyclus.}
        \end{minipage}
    \end{figure}
    \footnotetext{Feng, B., B. Dixon, E. Sunny, A. Cuadra, J. Jacobson, N. R. Brown, J. Powers, A. Worrall, S. Passerini, and R. Gregg. “Standardized Verification of Fuel Cycle Modeling.” Annals of Nuclear Energy 94 (August 2016): 300–312. https://doi.org/10.1016/j.anucene.2016.03.002.}
\end{frame}
...
\renewcommand{\topic}{Inventory of discharged and cooled UNF waiting for reprocessing}%
\renewcommand{\filename}{waiting}
\begin{frame}
    \frametitle{Results - \topic}
    \begin{figure}[htbp!]
        \begin{minipage}[b]{.45\linewidth}
...
\renewcommand{\topic}{Annual reprocessing rate}%
\renewcommand{\filename}{rep}
\begin{frame}
    \frametitle{Results - \topic}
    \begin{figure}[htbp!]
        \begin{minipage}[b]{.45\linewidth}
...
\renewcommand{\topic}{Inventory of unused TRU recovered from UNF}%
\renewcommand{\filename}{tru}
\begin{frame}
    \frametitle{Results - \topic}
    \begin{figure}[htbp!]
        \begin{minipage}[b]{.45\linewidth}
